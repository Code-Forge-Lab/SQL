...
SELECT DISTINCT state FROM customers --    Not Reaped same thing
...
Create cheme
CREATE SCHEMA `new_chema` ;

---------------------------------------------------------- Trash Code----------------------------------------------------------
CREATE  TABLE `databasa`.`cheme` ( 

  `idcheme` INT NOT NULL ,
...
INSERT INTO `databasa`.`cheme` (`idcheme`, `name`, `surname`, `age`) VALUES (1, 'John', 'Brine', 23);




//Info 
PK - Primary Key "Is Unequae key of numbers"


INSERT INTO `test`.`peple_data` (`idcheme`, `name`, `surname`, `age`) VALUES 
(2, 'Winy', 'Huge', 44),
(3, 'Braine', 'MCToch', 67),
(4, 'Wolter', 'Fazer', 27)